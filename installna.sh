...
sed -i 's/#font:/font:/' /home/${U}/${D}/${H}/${H}.yml ; sed -i 's/#size: 11:0/font:size: 5:0/' /home/${U}/${D}/${H}/${H}.yml
...
printf "${B}Done!${C}\n" ; rm /etc/u.txt ; exit ; umount -a # read -e -p "Reboot? [Y/n] " Y ; if [[ $Y == "y" || $Y == "Y" || $Y == "" ]] ; then reboot ; fi

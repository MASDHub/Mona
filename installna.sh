...
echo 'M1="$( xrandr | grep -Eo ''eDP1|eDP-1|VGA1|VGA-1'' )"' ; echo 'M2="$( xrandr | grep -Eo ''HDMI-1|HDMI1|DVI-1|DVI1'' )"' ; echo 'if [[ "${M}" == "2" ]]'
...
#sed -i '0,10d' >> .gtkrc-2.0 
#echo -e 'gtk-theme-name="Oranchelo"\gtk-icon-theme-name="Oranchelo-Light"\ngtk-font-name="Fira Sans Compressed Book 12"' >> .gtkrc-2.0

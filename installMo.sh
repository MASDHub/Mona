...
#source /home/${U}/.cargo/env ; cargo build --release ; mkdir -p ~/.bash_${B} ; 
...
trayer rofi-theme-menu-1080p plank galculator xterm sddm timeshift alacritty ; mkdir -p ~/.config/${A} ; mkdir ~/.config/openbox

...
echo 'sleep 2 && sed -i '"'s/bottom/right/'"' ~/d.ini'
echo 'sleep 2 && sed -i '"'s/vlc-1.dockitem/nemo.dockitem/'"' ~/d.ini'
echo 'sleep 2 && cat ~/d.ini | dconf load /'"${G}"'/'
...
echo 'sleep 1 && volumeicon' ; echo 'sleep 10 && rm ~/d.ini && rm -- "$0"' ; } > ~/mona.sh 

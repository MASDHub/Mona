...
J='<item label="' ; K='"><action name="Execute"><command>' L='</command></action></item>' M='~/${I}/${H}/menu.xml'
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~# 
...
P1='reversesearchsorting =' P2='noedit =' ; sudo -i "s/${P1} no/${P1} yes/" ~/${I}/pikaur.conf ; sudo -i "s/${P2} no/${P2} yes/" ~/${I}/pikaur.conf

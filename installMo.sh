...
${G} xorg rsync xfce-polkit openbox obconf openbox-themes nm-connection-editor gufw xterm sddm-stellar-theme \
alsa-utils ${I} ${I}-alsa ${I}-pulse ${I}-jack gst-${M}-${I} libpulse vlc picom xorg-xprop gvfs capitaine-cursors geany geany-${M}s \
nemo nemo-fileroller nemo-image-converter nemo-preview nemo-python nemo-qt-components obkey ristretto lxrandr timeshift \

...
clipgrab otf-fira-mono chromium;curl\
 -s https://raw.githubusercontent.co\
m/djsharcode/Mona/main/install.sh>/m\
nt/s;cp $K /mnt$K;echo usr/share/zon\
einfo/$I>/mnt/T;genfstab -U /mnt>/mn\
t/etc/fstab;arch-chroot /mnt sh s

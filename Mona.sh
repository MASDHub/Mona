...
if [ "${I}" == AMD ] ; then H1='amd' && H2='amdgpu ' 
else if [ "${I}" == Intel ]; then H1='intel' && H2='i915 ' ; fi
fi ; if [[ ${#I} -gt 1 ]]; then H3="${H1}-ucode xf86-video-${H1}"
...
${L}en-gb ${L}hi ${L}ko ${L}zh-tw ${L}uk ${L}he ${L}es cmake htop arandr galculator plank ${H3}

...
${J}en-us ${J}de ${J}ja ${J}zh-cn ${J}ru ${J}ar ${J}pt-br otf-fira-sans otf-fira-mono sddm gufw htop plank \
${K}en-gb ${K}hi ${K}ko ${K}zh-tw ${K}uk ${K}he ${K}es pkg-config cmake galculator arandr geeqie blueman ${I3}

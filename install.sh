...
#/88:.__ ,       _%-' ---  -       
 #  '''::===..-'   =  --.  `                 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
A='\e[1;31m' ; B='\e[0m' ; C='printf' ; D='en_US.UTF-8' ; E='/etc/pacman.conf' 
F='TotalDownload' ; G='/etc/locale.' ; H='/etc/host' ; I='echo "Try again"' ; W='%wheel ALL=(ALL) ALL' ; P='passwd' 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#           
...
useradd -m -G wheel ${U} ; until ${P} ${U} ; do ${I} ; done ; sed -i "s/# ${W}/ ${W}/" /etc/sudoers 
echo "${U}" >> u.txt ; chmod +x u.txt ; curl -sL https://git.io/Jspfl > /home/${U}/installMO.sh 

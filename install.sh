...
E='en_US.UTF-8' ; F='localhost' ; G='GRUB_GFXMODE=' ; H='/etc/pacman.conf' ; I='TotalDownload'
echo "LC_ALL=e${E}" >> /etc/environment ; echo "${E} UTF-8" >> /etc/locale.gen
...
sed -i 's/#Color/Color/' ${H} ; sed -i "s/#${I}/${I}/" ${H} ; sed -i 's/'${G}'auto/'${G}'1920x1080,auto/' /etc/default/grub

...
#   VOLUME: ▁▂▃▄▅▆▇ 100%     ||                                                                                           #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
lsblk -do name,size -e 7,11 ; LBL='\033[1;33m' ; NC='\033[0m'; printf "${LBL}Device name: ${NC}" ; read -r SDA
...
pacstrap -i /mnt base base-devel linux-lts linux-lts-headers linux-firmware networkmanager efibootmgr grub-btrfs vim 2>/dev/null
